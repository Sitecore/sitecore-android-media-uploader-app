...
public class ItemsListAdapter implements ItemViewBinder {
    ...
    public static final Builder IMAGE_PREVIEW_PARAMS = new Builder()
    ...
    public void bindView(Context context, View v, ScItem item) {
        ...
        if (ScUtils.isImageTemplate(template)) {
            final String url = ScUtils.getMediaDownloadUrl(context, item.getId(), IMAGE_PREVIEW_PARAMS.build());
